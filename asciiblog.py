...
try:
	...
	SQLALCHEMY_DATABASE_URI = os.environ.get('SQLALCHEMY_DATABASE_URI','postgres://rxdgcvbtsnxjsh:kAMbLMZD9jo7sxA_3OKpd4geoY@ec2-107-22-169-243.compute-1.amazonaws.com:5432/d9pa0tcjn1maaf')
	TWITTER_CONSUMER_KEY=os.environ.get('TWITTER_CONSUMER_KEY',"lYVO3CE6ju2rQrthjV9A")
	TWITTER_CONSUMER_SECRET=os.environ.get('TWITTER_CONSUMER_SECRET',"Vaoz1RpCT7UnJXXp5fy7w6zkSvdvdaHTZSoD2tSPw")
	TWITTER_ACCESS_TOKEN=os.environ.get('TWITTER_ACCESS_TOKEN',"22940852-RdxvzuSZVvJjr0FPrBzPckf5x9ZrSEzWeZLn9cXU")
	TWITTER_ACCESS_TOKEN_SECRET=os.environ.get('TWITTER_ACCESS_TOKEN_SECRET',"QBewJqXiRukVny2H3jjb88v19aKffsCcisl3v8MEI")
	pass
